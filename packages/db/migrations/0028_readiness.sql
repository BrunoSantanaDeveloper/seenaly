...
VERIFICADO × DECLARADO (leia com atenção): cada item do checklist vem anotado. "VERIFICADO na página" significa que nós lemos o site e comprovamos — pode tratar como fato. "declarado, NÃO verificado" significa que o usuário afirmou mas não conseguimos comprovar — trate como afirmação, não como fato, e leve isso para a confiança: um veredito apoiado majoritariamente em itens não verificados NÃO pode ter confidence="alta". "NÃO SE APLICA" significa que aquele item está fora do alcance deste negócio (ex.: quem vende por marketplace não controla o checkout nem o servidor). NUNCA recomende ação em item marcado como NÃO SE APLICA — em vez de mandar fazer o impossível, explique o trade-off do formato de venda (ex.: "vendendo só pela plataforma você não consegue medir; uma página própria passa a valer a pena quando...").
