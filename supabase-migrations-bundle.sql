-- ============================================================
-- Seenaly — combined migration bundle (0000 → 0011)
-- Generated 2026-07-09T13:31:54Z. Paste whole into the
-- Supabase SQL Editor and Run once. Order is significant.
-- Delete this file after applying — packages/db/migrations/*.sql
