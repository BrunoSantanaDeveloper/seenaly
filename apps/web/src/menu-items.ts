...
export const leftMenuItems: MenuItem[] = [
  ...
  },
  {
    id: "organic-growth",
    icon: "NiTrendUp",
    label: "menu-organic-growth",
    description: "menu-organic-growth-description",
    color: "text-primary",
    href: "/organic-growth",
    children: [
      {
        id: "organic-growth-overview",
        icon: "NiDashboard",
        label: "menu-organic-growth-overview",
        description: "menu-organic-growth-overview-description",
        href: "/organic-growth",
      },
      {
        id: "organic-growth-content",
        icon: "NiCamera",
        label: "menu-organic-growth-content",
        description: "menu-organic-growth-content-description",
        href: "/organic-growth/content",
      },
      {
        id: "organic-growth-strategy",
        icon: "NiChartFunnel",
        label: "menu-organic-growth-strategy",
        description: "menu-organic-growth-strategy-description",
        href: "/organic-growth/strategy",
      },
      {
        id: "organic-growth-reviews",
        icon: "NiDocumentChart",
        label: "menu-organic-growth-reviews",
        description: "menu-organic-growth-reviews-description",
  ...
  },
  {
    ...
    description: "menu-diagnosis-description",
    color: "text-primary",
    href: "/diagnosis",
  },
  {
