...
export default function NewFunnelSnapshotPage() {
  ...
  return (
    <Grid container spacing={5} className="items-start">
      <Grid size={"grow"} spacing={5} container>
        ...
        {(!configured || !currentOrg || !productId) && (
          <Grid size={12}>
            <Alert
              ...
              action={
                <Button color="info" size="small" variant="text" LinkComponent={Link} href="/funnel">
                  {t("pick-product-cta")}
                </Button>
              }
            >
        ...
        {configured && currentOrg && productId && (
          <Grid size={12}>
            <FunnelForm orgId={currentOrg.id} productId={productId} />
          </Grid>
        )}
      </Grid>
    </Grid>
